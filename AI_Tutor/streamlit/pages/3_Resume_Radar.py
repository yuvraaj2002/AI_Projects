...
def clean_data(text):
    """
        ...
        6. **Rejoining:** Joins the remaining words back into a string with spaces in between.

        Args:
            pdf_data (bytes): The PDF data to be processed.

        Returns:
            str: The cleaned text with stop words, punctuation, phone numbers, and email addresses removed.
        """
