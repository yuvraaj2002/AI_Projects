    ...
    with config_col:
        ...
        if analyze_gestures_bt:
            if video_upload is not None:
                ...
                temp_pred_file_avi = os.path.join(prediction_folder, os.listdir(prediction_folder)[0])
                ...
                shutil.rmtree("/home/yuvraj/Documents/AI/AI_Projects/AI_Tutor/runs/detect")
